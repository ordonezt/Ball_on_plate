...
def send_command_to_platform(port,x_ang,y_ang,altura):
    ...
    try:
        ...
        ang_motor_1= int( (p.ang1*180/np.pi +90) *1000   ) # Multiplico por mil porque el frame es en milesimas de grado
        ang_motor_2= int( (p.ang2*180/np.pi +90) *1000   )
        ang_motor_3= int( (p.ang3*180/np.pi +90) *1000   )
